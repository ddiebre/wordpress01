	...
	<?php if ( ! post_password_required() && ! is_attachment() ) : ?>
		<?php if ( is_single() ) { ?>
				...
				<?php if (do_shortcode(get_post_meta( $post->ID, '_makali_post_intro', true )) != '') { ?>
					<div class="player"><?php echo do_shortcode(get_post_meta( $post->ID, '_makali_post_intro', true )); ?></div>
				<?php } ?>
			<?php }
		?>
		<?php if ( !is_single() ) { ?>
			<?php if ( has_post_thumbnail() ) { ?>
				<div class="post-thumbnail-wrapper">
					<div class="post-thumbnail">
						<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail($makali_postthumb); ?></a>
						<?php if(has_category()) { ?>
							<div class="post-category">
								<?php echo get_the_category_list(' '); ?>
							</div> 
