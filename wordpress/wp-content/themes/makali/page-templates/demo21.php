...
if(count($jscomposer_templates) > 0) {
	foreach($jscomposer_templates as $jscomposer_template){
		if($jscomposer_template->post_title == 'Header 7' || $jscomposer_template->post_title == 'Footer 4'){
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper">
		<div class="page-wrapper">
			<div class="header-container header-7 demo-21 rs-active">  
			 	<div class="header">
					<div class="header-content">
						...
						if ( isset($makali_opt['header_layout']) && $makali_opt['header_layout']!="") {
							...
							if(count($jscomposer_templates) > 0) {
								foreach($jscomposer_templates as $jscomposer_template){
									if($jscomposer_template->post_title == 'Header 7'){
										?>
