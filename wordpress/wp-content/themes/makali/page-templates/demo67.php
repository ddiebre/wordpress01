...
if(count($jscomposer_templates) > 0) {
	foreach($jscomposer_templates as $jscomposer_template){
		if($jscomposer_template->post_title == 'Header 29' || $jscomposer_template->post_title == 'Footer 5'){
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper">
		<div class="page-wrapper">
			<div class="header-container header-29 rs-active">  
			 	<div class="header">
					<div class="header-content">
						...
						if ( isset($makali_opt['header_layout']) && $makali_opt['header_layout']!="") {
							...
							if(count($jscomposer_templates) > 0) {
								foreach($jscomposer_templates as $jscomposer_template){
									if($jscomposer_template->post_title == 'Header 29'){
										?>
			...
			<div class="footer footer-5">
				<div class="footer-inner">
					...
					if ( isset($makali_opt['footer_layout']) && $makali_opt['footer_layout']!="" ) {
						...
						if(count($jscomposer_templates) > 0) {
							foreach($jscomposer_templates as $jscomposer_template){
								if($jscomposer_template->post_title == 'Footer 5'){
									echo do_shortcode(apply_filters( 'the_content', $jscomposer_template->post_content ));
								}
							}
						}
