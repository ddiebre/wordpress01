...
if(count($jscomposer_templates) > 0) {
	foreach($jscomposer_templates as $jscomposer_template){
		if($jscomposer_template->post_title == 'Header 4' || $jscomposer_template->post_title == 'Footer 3'){
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper">
		<div class="page-wrapper">
			<div class="header-container header-4 demo-20 rs-active">  
			 	<div class="header">
			...
			<div class="footer footer-3 demo-20">
