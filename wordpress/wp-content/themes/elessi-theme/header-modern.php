...
<?php /* !-- Start Header Site -->
<header id="header-content" class="site-header header-checkout-modern row">
    <div class="large-12 columns ct-flex">
        <h1><?php echo esc_html__('CHECKOUT', 'elessi-theme'); ?></h1>
