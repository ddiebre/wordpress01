<div class="wrap" id="of_container">
    ...
    <form id="of_form" method="post" action="" enctype="multipart/form-data">
        ...
        <div id="header">
            <div class="logo">
                <h2><?php echo ELESSI_ADMIN_THEMENAME; ?></h2>
                <span style="margin-left: 30px;"><a href="<?php echo esc_url(ELESSI_ADMIN_SUPPORT_FORUMS); ?>" target="_blank"><?php esc_html_e('Online Documentation', 'elessi-theme'); ?></a></span>
            </div>
        ...
        <div id="info_bar">
            <a><div id="expand_options" class="expand"><?php esc_html_e('Expand', 'elessi-theme'); ?></div></a>
        ...
        <div class="save_bar"> 
            ...
            <button id ="of_save" type="button" class="button-primary"><?php esc_html_e('Save All Changes', 'elessi-theme'); ?></button>			
