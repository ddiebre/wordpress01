...
if (!function_exists('elessi_single_stock')) :
    function elessi_single_stock($html, $product) {
        ...
        $new_html .= sprintf(esc_html__('HURRY! ONLY %s LEFT IN STOCK.', 'elessi-theme'), '<b>' . $stock_available . '</b>');
        $new_html .= '</span>';
...
if (!function_exists('elessi_loop_product_content_thumbnail')) :
    function elessi_loop_product_content_thumbnail() {
        ...
        $class_wrap .= (isset($nasa_opt['single_product_ajax']) && $nasa_opt['single_product_ajax']) ? ' nasa-ajax-call' : '';
        ?>
...
if (!function_exists('elessi_ajax_single_product_tag')) :
    function elessi_ajax_single_product_tag() {
        ...
        echo (isset($nasa_opt['single_product_ajax']) && $nasa_opt['single_product_ajax']) ? '<div id="nasa-single-product-ajax" class="hidden-tag"></div>' : '';
    }
endif;
...
if (!function_exists('elessi_loop_product_content_title')) :
    function elessi_loop_product_content_title() {
        ...
        $class_title .= (isset($nasa_opt['single_product_ajax']) && $nasa_opt['single_product_ajax']) ? ' nasa-ajax-call' : '';
        ?>
...
if (!function_exists('elessi_open_woo_main')) :
    function elessi_open_woo_main() {
         ...
         */
        if (isset($nasa_opt['single_product_ajax']) && $nasa_opt['single_product_ajax'] && is_product()) :
