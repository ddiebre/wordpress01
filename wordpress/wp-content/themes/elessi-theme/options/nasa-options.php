...
function elessi_enqueue_style() {
    ...
    if (!$inMobile) {
         ...
         * CSS Animate
         */
        wp_enqueue_style('elessi-animate', ELESSI_THEME_URI . '/assets/css/animate.min.css', array('elessi-style'));
        
        /**
         * Style Large
         */
        wp_enqueue_style('elessi-style-large', ELESSI_THEME_URI . '/assets/css/style-large.css', array('elessi-style'));
    }
    ...
    if (defined('YITH_WCPB')) {
        wp_enqueue_style('elessi-style-yith_bundle', ELESSI_THEME_URI . '/assets/css/style-yith_bundle.css', array('elessi-style'));
    }
    ...
    if (elessi_check_blog_page()) {
        wp_enqueue_style('elessi-style-posts', ELESSI_THEME_URI . '/assets/css/style-posts.css', array('elessi-style'));
    }
    ...
    if (NASA_WOO_ACTIVED) {
        ...
        if (NASA_DOKAN_ACTIVED) {
            wp_enqueue_style('elessi-style-dokan-store', ELESSI_THEME_URI . '/assets/css/style-dokan-store.css', array('elessi-style'));
        }
        ...
        if (is_shop() || is_product_taxonomy()) {
            if (!$inMobile) {
                wp_enqueue_style('elessi-style-products-list', ELESSI_THEME_URI . '/assets/css/style-products-list.css', array('elessi-style'));
            }
            
            wp_enqueue_style('elessi-style-archive-products', ELESSI_THEME_URI . '/assets/css/style-archive-products.css', array('elessi-style'));
        }
         ...
         */
        if (is_product()) {
            wp_enqueue_style('elessi-style-signle-product', ELESSI_THEME_URI . '/assets/css/style-single-product.css', array('elessi-style'));
        }
        ...
        if (is_checkout() || is_cart() || (NASA_CORE_USER_LOGGED && is_account_page())) {
            wp_enqueue_style('elessi-style-woo-pages', ELESSI_THEME_URI . '/assets/css/style-woo-pages.css', array('elessi-style'));
        }
    }
}
...
function elessi_enqueue_scripts() {
    ...
    if ($enable_live_search && NASA_WOO_ACTIVED) {
        ...
        wp_enqueue_script('nasa-handlebars', ELESSI_THEME_URI . '/assets/js/min/handlebars.min.js', array('jquery'), null, true);
    ...
    if (NASA_WOO_ACTIVED) {
        ...
        if ((!isset($nasa_opt['disable-quickview']) || !$nasa_opt['disable-quickview'])) {
            ...
            wp_enqueue_script('nasa-quickview', ELESSI_THEME_URI . '/assets/js/min/nasa-quickview.min.js', array('jquery'), null, true);
         ...
         */
        if (is_checkout() || is_cart() || (NASA_CORE_USER_LOGGED && is_account_page())) {
            wp_enqueue_script('nasa-woo-pages', ELESSI_THEME_URI . '/assets/js/min/woo-pages.min.js', array('jquery'), null, true);
        }
    ...
    if (!NASA_CORE_ACTIVED) {
        wp_enqueue_script('elessi-nasa-core', ELESSI_THEME_URI . '/assets/js/min/nasa-core.min.js', array('jquery'), $themeVersion, true);
    }
}
...
function elessi_get_list_css_files_call() {
    $list_css = array(
        'elessi-animate' => esc_html__("Theme Animation", 'elessi-theme'),
    ...
    if (NASA_ELEMENTOR_ACTIVE) {
        ...
        $list_css['elementor-animations'] = esc_html__("Elementor Animate", 'elessi-theme');
    }
