    ...
    $('body').on('click', '.nasa-shipping-step', function () {
        if (!$('.nasa-bc-modern .nasa-shipping-step').hasClass('active')) {
            ...
            if (_valid) {
                ...
                $('.woo-billing').fadeOut(200);
                $('#nasa-step_billing').fadeOut(200);
                $('#nasa-payment-wrap').fadeOut(200);
                
                if ($('.woocommerce-form-login-toggle').length) {
                    $('.woocommerce-form-login-toggle').fadeOut(200);
                    $('.woocommerce-form-login').fadeOut(200);
                }
    ...
    $('body').on('click', '.nasa-payment-step', function() {
        if (!$('.nasa-bc-modern .nasa-payment-step').hasClass('active')) {
            ...
            if (_valid) {
                ...
                $('.woocommerce-additional-fields').fadeOut(200);
                $('.woo-billing').fadeOut(200);
                $('#nasa-shipping-methods').fadeOut(200);
                $('#nasa-step_payment').fadeOut(200);
                $('#nasa-step_billing').fadeOut(200);
