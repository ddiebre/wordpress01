    ...
    $(window).scroll(function() {
        var scrollTop = $(this).scrollTop();
            if ($('.nasa-product-details-page .single_add_to_cart_button').length) {
                var addToCart = $('.nasa-product-details-page #nasa-single-product-tabs') || $('.nasa-product-details-page .single_add_to_cart_button');
                if ($(addToCart).length) {
            ...
            if ($('.nasa-product-details-page .woosb-product').length) {
                ...
                if ($('.product-thumbnails').length) {
                    ...
                    if (src_thumb) {
                        ...
                        if ($('body').hasClass('nasa-focus-main-image') && $('.product-thumbnails .nasa-wrap-item-thumb[data-key="0"] a').length) {
                            $('.product-thumbnails .nasa-wrap-item-thumb[data-key="0"] a').trigger('click');
                        }
