		...
		public static function content() {
			...
			$gutentor_block_collection = array(
				...
				'callback-to-action' => array(
					'title'       => esc_html__( 'Callback To Action Widget', 'gutentor' ),
				...
				'opening-hours'      => array(
					...
					'description' => esc_html__( 'The Opening Hours Widget depicts the information related to opening schedule of any organization or any place with cool templates.', 'gutentor' ),
				),
				'pricing'            => array(
					'title'       => esc_html__( 'Pricing Widget', 'gutentor' ),
					'description' => esc_html__( 'The Pricing Widget block represents the pricing details of any commodity with number of customize features and cool templates .', 'gutentor' ),
				),
				'progress-bar'       => array(
