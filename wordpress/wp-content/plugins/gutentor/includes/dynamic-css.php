...
if ( ! class_exists( 'Gutentor_Dynamic_CSS' ) ) :
	...
	class Gutentor_Dynamic_CSS {
		...
		/**
		 * Concat Google Font Family from URL
		 *
		 * @since    1.0.0
		 * @access   public
		 *
		...
		public function concat_google_font( $f1, $f2 ) {
			echo 'Here';
			echo '<br/>';
			echo $f1;
			echo '<br/>';
		...
		public function get_tax_term_css( $request ) {
			...
			$default_cat_bg_enable = isset( $default_cat_bg_color['enable'] ) ? $default_cat_bg_color['enable'] : false;
